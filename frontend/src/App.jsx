...
import EventSelectionTech from "../components/EventSelectionTech";
// import Login_SignUp from '../components/login_signup';

function Home({ cards = [] }) {
	// Add default [] to avoid undefined errors
	return (
		<>
			<HeroSection
			...
			<div>
				...
				{/* Use the correct imported component */}
			</div>
	...
	return (
		<Routes>
			<Route path="/" element={<MainLayout />}>
				...
				{/* Consider lowercase for consistency */}
				<Route path="testimonials" element={<Testimonial />} />
				<Route path="registration" element={<RegistrationPage />} />
				<Route path="/event-selection-s2" element={<EventSelection />} />
