...
const event2 = {
  ...
  description: "A dynamic tech fest focusing on emerging technologies, workshops, and day 2 highlights in innovation and entertainment.",
  ...
  date: "December 5",
  year: "2025",
  detailedDescription: "Dive into the future of tech with hands-on sessions and exciting day 2 events.",
...
const FullscreenCarousel = () => {
  ...
  const handleEventTitleClick2 = () => {
    // Similar structure for event2 details
    const eventDetails = {
      date: "Dec 5 - 6",
      year: "2025",
      ...
      description: "A tech fest with focus on day 2 innovations and entertainment.",
      registrationFee: "NA as of now",
      teamSize: "Individual & Team Events",
    ...
    <>
      ...
      <div className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 p-4">
        ...
        <div className="relative w-full max-w-4xl h-96 flex items-center justify-center overflow-hidden rounded-xl shadow-xl">
          {/* Active Slide - Fade in/out effect */}
          <div 
            className="absolute w-full h-full transition-opacity duration-1000 ease-in-out opacity-100"
            style={{ opacity: 1 }}
          >
            <EventCard 
          ...
          {/* Previous Slide (for smooth transition) - Hidden */}
          <div 
            className="absolute w-full h-full transition-opacity duration-1000 ease-in-out opacity-0"
          >
            <EventCard 
              eventData={events[(currentSlide - 1 + events.length) % events.length]} 
              onRegister={handleRegisterClick}
              onViewDetails={handleEventTitleClick}
            />
          </div>
