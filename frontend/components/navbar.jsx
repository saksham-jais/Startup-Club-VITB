...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-[1000] w-full bg-gradient-to-r from-gray-50/90 to-white/90 py-[25px] border-b border-blue-400/10">
        ...
        <div className="max-w-[1100px] mx-auto px-10 w-full flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="relative px-6 py-3 bg-blue-400 text-white no-underline text-[16px] font-semibold transition-all duration-300 ease-in-out overflow-hidden rounded-lg shadow-md hover:shadow-lg before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-r before:from-[rgba(96,165,250,0.3)] before:to-[rgba(96,165,250,0.3)] before:translate-x-[-100%] before:transition-transform before:duration-[600ms] hover:before:translate-x-full hover:[text-shadow:_0_0_5px_rgba(255,255,255,0.5)] hover:bg-blue-500 active:scale-95 active:shadow-inner"
            >
              Register Now
            </button>
          </div>
